      ...
      <footer className="border-t border-neutral-800">
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-8 px-6 py-12 md:grid-cols-3 md:px-8">
          ...
          <div className="space-y-3">
            <p className="flex items-center gap-2"><Phone className="h-5 w-5 text-secondary hover:underline hover:text-primary" /><a className="hover:underline hover:text-primary" href="tel:+447485041755"> +44 7485 041755</a></p>
