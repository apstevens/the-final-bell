  ...
  return (
    <div className="min-h-screen w-full bg-neutral-950 text-neutral-100">
      ...
      >
        ...
        <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-4 m-8 text-xs text-neutral-400">
          <p className="mb-1">
            <strong className="text-neutral-300">Secure Checkout</strong>
          </p>
          <p>
            You'll be redirected to our secure payment partner (Stripe) to enter your payment details. See our{" "}
            <a
              href="/privacy-policy"
